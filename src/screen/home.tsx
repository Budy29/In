        ...
        <View style={styles.container}>
            ...
            <View style={styles.container_Box}>
                <View style={{ width: '100%', height: '50%', flexDirection: 'row', padding: '5%', justifyContent: 'center', alignItems: 'center' }}>
                    <TouchableOpacity style={{ width: '45%', height: '100%', backgroundColor: '#B9E1D3', borderRadius: 20, justifyContent: 'center', alignItems: 'center' }}>
                        <Box />
                        <Text style={{ color: '#000000', fontSize: 24, fontWeight: '800' }}>Barang</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={{ width: '45%', height: '100%', backgroundColor: '#44E7AC', marginLeft: '5%', borderRadius: 20, justifyContent: 'center', alignItems: 'center' }}>
                        <Book style={{ marginTop: '5%' }} />
                        <Text style={{ color: '#000000', fontSize: 24, fontWeight: '800', marginTop: '5%' }}>Dokumen</Text>
                    </TouchableOpacity>
                </View>
                <View style={{ width: '100%', height: '50%', flexDirection: 'row', padding: '5%', justifyContent: 'center', alignItems: 'center', }}>
                    <TouchableOpacity style={{ width: '45%', height: '100%', backgroundColor: '#44E7AC', borderRadius: 20, justifyContent: 'center', alignItems: 'center', marginTop: '-10%' }}>
                        <Dollars style={{ marginTop: '5%' }} />
                        <Text style={{ color: '#000000', fontSize: 24, fontWeight: '800', marginTop: '2%' }}>Biaya</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={{ width: '45%', height: '100%', backgroundColor: '#B9E1D3', marginLeft: '5%', borderRadius: 20, justifyContent: 'center', alignItems: 'center', marginTop: '-10%' }}>
                        <ReportAtivity />
